% Simulate random sources along a finite-width donut and include a spurious
% source
%
% jbrussell - 7/2023
...
%                         Si_A = Si_A + amp_S(isrc) .* ricker_wavelet(t-tshift(ii)-dt_repeat*jj,R_Si_A,grv,f_cent);
%                         Si_B = Si_B + amp_S(isrc) .* ricker_wavelet(t-tshift(ii)-dt_repeat*jj,R_Si_B,grv,f_cent);
%                     end
%                 end
            end
        end
